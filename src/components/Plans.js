...
function Plans() {
    ...
    return (
        <div className="Plans">
            <div className="headingPlans">
                <h2 align="center" data-text="Pick a plan and get 10,000 free conferencing minutes">Pick a plan and get 10,000 free conferencing minutes</h2>
            </div>
            <p align="center" className="h4">After the first 10,000 free minutes, you pay only for what you use. No lock-in.</p>
            <div className="Plansinfo row ">
                    <div className="video-plan-1 col-12 col-lg-5">
                        <div className="icon"><img src="https://img.icons8.com/plasticine/144/000000/camera--v1.png" alt="Camera"/></div>
                ...
                <div className="video-plan-2 col-12 col-lg-5">
                    <div className="icon"><img src="https://img.icons8.com/nolan/144/headphones.png" alt="Headphones"/></div>
